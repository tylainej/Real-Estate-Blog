...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { article_id_id: @area.article_id_id, location: @area.location } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { article_id_id: @area.article_id_id, location: @area.location } }
